...
// Function to validate and sanitize URL (basic sanitization)
const sanitizeUrl = (url) => {
  try {
    ...
    if (
      ...
      return sanitizedUrl.href; // If valid, return the URL
    } else {
      ...
      >
        <div className="content">
          ...
          <div className="container bg-white">
            <div className="row">
              {product.map((product) => (
                <div className="col-lg-3 col-sm-6 d-flex flex-column align-items-center justify-content-center product-i my-3">
                  <div className="product">
                    <img
                      src={sanitizeUrl(product.image)} // Sanitize the image URL
                      alt={product.name}
